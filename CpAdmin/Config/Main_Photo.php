...
$MainArr = array("Col"=> "col-md-12" ,"StopView" => '1','required' => '', "path"=> LOGOS_IMAGE_DIR_V ,'NewStyle'=> "DefaultLogo" ) ;
...
echo '<div class="col-md-6 DirRight">';
New_Print_Alert("5","خلفيه");  
$FildName = "photo_back"; $Arr = $MainArr+array("name"=> $FildName ,"photo"=> $row[$FildName]);
New_PrintFilePhoto("Edit",$Arr);
echo '</div>';
