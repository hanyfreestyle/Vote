...
switch($view) {
    ...
    case 'SMSConfig':
        $content =  UserPerMatianCont('SMS_Config.php',$USER_PERMATION_Edit);
        $ThisMenuIs_li = $ThisMenuIs.'SMSConfig';
        $PageTitle = $Module_H1.$AdminLangFile['webconfig_sms_but'] ;
        $Short_Menu = '_Short_Menu.php';
        $Short_Menu_Sel = 'SMSConfig';
        break;
...
#################################################################################################################################        
    case 'ConfigEmail':
        $content =  UserPerMatianCont('Config_Email_List.php',$USER_PERMATION_Edit);
     ...
     case 'AddEmail':
        $content =  UserPerMatianCont('Config_Email_Update.php',$USER_PERMATION_Edit);
        $ThisMenuIs_li = $ThisMenuIs.'ConfigEmail';
...
#################################################################################################################################        
     case 'EmailConfig':
        $content =  UserPerMatianCont('SMS_Email_Config.php',$USER_PERMATION_Edit);
        $ThisMenuIs_li = $ThisMenuIs.'EmailConfig';
        $PageTitle = $Module_H1.$AdminLangFile['webconfig_emailconfig'] ;
        $Short_Menu = '_Short_Menu.php';
        $Short_Menu_Sel = 'EmailConfig';
        break;
