...
if ($already > 0){
    ...
    Table_TH_Print($Mod_Sales,$ALang['users_sales_group'],"50");
    Table_TH_Print($Mod_Customers_Service,$ALang['users_custserv_group'],"50");
    ...
    TableClose_Header();
     ...
     if ($NOPAGE != 1){
        ...
        for($i = 0; $i < count($Name); $i++) {
            ...
            Table_TD_Print($Mod_Sales,GroupStatePrint($Name[$i]['sales']),"C");
            Table_TD_Print($Mod_Customers_Service,GroupStatePrint($Name[$i]['custserv']),"C");
