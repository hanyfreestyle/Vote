...
function Etman_CustomerAdd($db){
    ...
    $server_data = array ('id'=> NULL ,
        ...
        ##
        'complaint_id'=> SendArrToSql("complaint_id"),
        'citylist_id'=> SendArrToSql("citylist_id"),
        'photo'=> $photoUp['photo'] ,
...
###################################################    Etman_CustomerAdd
#################################################################################################################################
function Etman_CustomerEdit($db){
    $ThisIsTest = "0";
    global $ALang ;
    $id = $_GET['id'];
    $Err_2 = "";
...
function NewCheckWhenWeNeed(){
    ...
    /*
    $NameLetterCount = trim($_POST['name']);
    $NameLetterCount  =  mb_strlen($NameLetterCount); 

    if($NameLetterCount < $ConfigP['cust_namecount'] ){
    SendJavaErrMass($ALang['cust_add_name_count_err']);
    $MainErr = '1'; 
    }
    */
   return $MainErr ;
