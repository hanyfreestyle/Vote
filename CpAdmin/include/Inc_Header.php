...
<link rel="stylesheet" href="<?php echo $AdminPath ?>WebCss/NewChart.css">
<link rel="stylesheet" href="<?php echo $AdminPath ?>WebCss/EditStyle_<?php echo ADMIN_WEB_LANG ?>.css">


<script type="text/javascript" src="<?php echo $AdminPath ?>inc/tokeninput/jquery.tokeninput.js"></script>
<link rel="stylesheet" href="<?php echo $AdminPath ?>inc/tokeninput/token-input-facebook.css" type="text/css" />
...
$(document).ready(function() {
    var parsleyConfig = {
        errorsContainer: function(parsleyField) {
            ...
            var fieldSet = parsleyField.$element.closest('fieldset_checkbox');
            var fieldSet_2 = parsleyField.$element.closest('fieldset_checkboxGroup');
            ...
            if (fieldSet_2.length > 0) {
                return fieldSet_2.find('#checkbox-errorsGroup');
            }
...
$(document).ready(function() {
    var parsleyConfig = {
        errorsContainer: function(parsleyField) {
            // fieldInstance is a ParlseyField instance
            // you can access the dom element with fieldInstance.$element
            var fieldSet = parsleyField.$element.closest('fieldset_checkboxGroup');
            
            // if this element is nested inside a fieldset, set the container as the last element of that fieldset
            if (fieldSet.length > 0) {
                return fieldSet.find('#checkbox-errorsGroup');
            }
