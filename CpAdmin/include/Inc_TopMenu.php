...
echo '<li><a  href="'.$AdminPathHome.'SalesDep/index.php?view=TeamLeader&active=0">'.$AdminLangFile['users_unactive_team_leader'].'</a></li>';       
}else{
echo '<li><a  href="'.$AdminPathHome.'SalesDep/index.php?view=TeamLeader&active=1">'.$AdminLangFile['users_active_team_leader'].'</a></li>';    
}    
echo '<li class="divider"></li>';   
}  
...
echo '<li><a href="'.$AdminPathHome.'Config/index.php?view=WebConfig"><em class="fa fa-cogs topmenu_fa"></em></a></li>';  
echo '<li><a href="'.$AdminPathHome.'Landing/index.php?view=ListPage"><em class="fa fa-html5 topmenu_fa"></em></a></li>';
*/ 
}
