...
**************************************************************************************/
	...
	public function Send_SMS($Mobiles,$Sender,$Msg){
        ...
        //self::$URLGateway_Send."?username=".$this->UserName."&password=".$this->Password."&mobile=".$Numr."&sender=".$Sender."&message=".$Msg."&unicode=".$UC
        
        $url ="http://sms.malath.net.sa/httpSmsProvider.aspx?username=".$this->UserName."&password=".$this->Password."&mobile=".$Mobiles."&sender=".$Sender."&message=".$Msg."&unicode=".$UC;
