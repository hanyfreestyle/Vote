...
###################################################    
#################################################################################################################################
function TableClose_Header($MyArr=array()){
echo '</tr></thead><tbody>';    
}
...
###################################################    
#################################################################################################################################
function Table_TH_Print($View,$Name,$Width="50",$MyArr=array()){
   if($View == '1'){
   if($Width != '0' ){$TH_Class = "TD_".$Width." ";}else{$TH_Class = "";} 
   $Style = ArrIsset($MyArr,"OtherStyle","");   
   echo  $kk = '<th class="'.$TH_Class." ".$Style.'">'.$Name.'</th>'; 
   } 
...
###################################################    
#################################################################################################################################
function Table_TD_Print($View,$Val,$Align="C",$MyArr=array()){
   $Style = ArrIsset($MyArr,"OtherStyle","");
   if($View == '1'){
...
function Table_TD_Print_Option($View,$Val,$Align="C",$MyArr=array()){
   $Style = ArrIsset($MyArr,"OtherStyle","");
   if($View == '1'){
   if($Align == 'C' ){$Align = "center";} if($Align == 'R' ){$Align = "right";}    if($Align == 'L' ){$Align = "left";}       
     echo  $kk = '<td align="'.$Align.'" class=" '.$Style.'"  >'.$Val.'</td>'; 
...
function Table_TD_Print_Photo($View,$Val,$Align="C",$Arr=""){
    global $AdminNoPhoto ;
...
###################################################    
#################################################################################################################################
function CloseTabel_2($Arr=array()){
    global $ConfigP ;
    global $db ;
    if(!isset($ConfigP['datatabel'])){
    $ConfigP['datatabel'] = "0"  ;  
...
function Alert_NO_Content($Name=""){
    ...
    echo '<div class="alert alert-danger alert_danger_ar text-right ">'.$Name.'</div>';
}
