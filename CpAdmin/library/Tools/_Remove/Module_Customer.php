...
function CustomerAdd($db) {
    ...
    'jop_id'=>PostIsset("jop_id"),
    'religion'=>PostIsset("religion"),
    
    
    'social_id'=> PostIsset("social_id"),
    'kind_id'=> PostIsset("kind_id"),
    'live_id'=> PostIsset("live_id"),
    'state'=> "1" ,
   ...
   if($CustmerTYpeAddSecion == 'Hotline_Add'){
    ...
    SendJavaErrMass($AdminLangFile['mainform_duplicated_data']);
       ...
       if($CustmerTYpeAddSecion == 'Customer_Add'){   
         ...
         $Err_2 =  PrintErrFromSQL_ForCust_2("mobile",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile']));
         
         if($Err_2 != "1"){
         $Err_2 =  PrintErrFromSQL_ForCust_2("mobile_2",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile_2']));  
         } 
              
         if($Err_2 != "1"){
           $Err_2 =  PrintErrFromSQL_ForCust_2("phone",$AdminLangFile['customer_phone']." ".Clean_Mypost($_POST['phone']));  
         }    

        if($Err_2 != "1"){
         $Err_2 =  PrintErrFromSQL_ForCust_2("email",$AdminLangFile['customer_email']." ".Clean_Mypost($_POST['email']));  
        }               

        if($Err_2 != "1"){
           $Err_2 =  PrintErrFromSQL_ForCust_2("id_no",$AdminLangFile['customer_national_id']." ".Clean_Mypost($_POST['id_no']));  
        }
...
function CustomerEdit($db) {
   ...
   $server_data =  RemoveFildeFromArrWhenAdd ($server_data);
    ...
    $Err_2 =  PrintErrFromSQL_ForCust_2("mobile",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile']),$id);
    
    if($Err_2 != "1"){
    $Err_2 =  PrintErrFromSQL_ForCust_2("mobile_2",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile_2']),$id);
    }
    if($Err_2 != "1"){
    $Err_2 =  PrintErrFromSQL_ForCust_2("phone",$AdminLangFile['customer_phone']." ".Clean_Mypost($_POST['phone']),$id);
    }
    
    if($Err_2 != "1"){
    $Err_2 =  PrintErrFromSQL_ForCust_2("email",$AdminLangFile['customer_email']." ".Clean_Mypost($_POST['email']),$id);
    }
    
    if($Err_2 != "1" and isset($_POST['id_no'])){
    $Err_2 =  PrintErrFromSQL_ForCust_2("id_no",$AdminLangFile['customer_national_id']." ".Clean_Mypost($_POST['id_no']),$id);
    }
...
$Err_2 =  PrintErrFromSQL_ForCust_2("mobile",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile']),$MyCustMerIdd);

if($Err_2 != "1"){
$Err_2 =  PrintErrFromSQL_ForCust_2("mobile_2",$AdminLangFile['customer_mobile']." ".Clean_Mypost($_POST['mobile_2']),$MyCustMerIdd);
}
if($Err_2 != "1"){
$Err_2 =  PrintErrFromSQL_ForCust_2("phone",$AdminLangFile['customer_phone']." ".Clean_Mypost($_POST['phone']),$MyCustMerIdd);
}

if($Err_2 != "1"){
$Err_2 =  PrintErrFromSQL_ForCust_2("email",$AdminLangFile['customer_email']." ".Clean_Mypost($_POST['email']),$MyCustMerIdd);
}

if($Err_2 != "1"){
$Err_2 =  PrintErrFromSQL_ForCust_2("id_no",$AdminLangFile['customer_national_id']." ".Clean_Mypost($_POST['id_no']),$MyCustMerIdd);
}
...
###################################################   PrintOldTicket
#################################################################################################################################
function PrintOldTicket($Cust_Id,$CruntTicket){
    global $db;
    global $AdminLangFile ;
    global $NamePrint ;
