...
####################################################################################################################################
///// طريقة التواصل
    if( F_LEAD_TYPE  == 1 and ($AdminConfig['leads'] == 1) or F_LEAD_TYPE  == 1 and ($ConfigP['view_lead_type'] == 1) ){
...
####################################################################################################################################
///// مصدر التواصل
    if( F_LEAD_SOURS  == 1 and ($AdminConfig['leads'] == 1) or F_LEAD_SOURS  == 1 and ($ConfigP['view_lead_sours'] == 1) ){
...
####################################################################################################################################
/////  الحملة الاعلانية   
    if( F_LEAD_CAT  == 1 and ($AdminConfig['leads'] == 1) or F_LEAD_CAT  == 1 and ($ConfigP['view_lead_cat'] == 1) ){
