...
$CatId = Get_CatId();
$CatIdFilter = $CatId['ProIdFilter']; 

$CityId = Get_CityId();
$CityIdFilter = $CityId['ProIdFilter']; 

$AreaId = Get_AreaId();
$AreaIdFilter = $AreaId['ProIdFilter']; 


$THESQL = "SELECT * FROM $ThisTabelName where state = '1' and  cust_id = '$CustMembers_Id' $NewState $CatIdFilter $CityIdFilter $AreaIdFilter $orderby";
...
$THELINK = "view=".$view.$CatId['ProIdLink'].$CityId['ProIdLink'].$AreaId['ProIdLink'];
