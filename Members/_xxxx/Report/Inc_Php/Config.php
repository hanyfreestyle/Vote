...
$Err = MainConfigSection("report","0",array('ActiveMode'=>'1')) ;


$MoreS = array('Col' => "col-md-3",'required' => 'required data-parsley-type="digits" ', 'Dir'=> "En");
$Err[] = NF_PrintInput("TextEdit",$ALang['mainform_chart_results_count'],"chart_count","0","","req",$MoreS);



echo '<div style="clear: both!important;"></div>'.BR.BR;
New_Print_Alert("5","تقرير المنتجات"); 

NF_PrintRadio_Active ("2_Line","col-md-3","عرض المؤشر","catpro_chartview",$catpro_chartview);


$MoreS = array('Col' => "col-md-3",'required' => 'required data-parsley-type="digits" ', 'Dir'=> "En");
$Err[] = NF_PrintInput("TextEdit","عدد النتائج","catpro_reslutcount","0","","req",$MoreS);
...
###################################################    
#################################################################################################################################
New_Print_Alert("5",$ALang['report_chart_view_c']);  
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_religion'],"religion",$religion);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_payment'],"payment",$payment);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_branch'],"branch",$branch);

NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_custfilter_1'],"filter_1",$filter_1);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_custfilter_2'],"filter_2",$filter_2);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_custfilter_3'],"filter_3",$filter_3);

NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_empl_1'],"empl_1",$empl_1);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_empl_2'],"empl_2",$empl_2);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_empl_3'],"empl_3",$empl_3);
 
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_country'],"country_id",$country_id); 
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_city'],"city_id",$city_id);
NF_PrintRadio_Active ("2_Line","col-md-3",$ALang['cust_area'],"area_id",$area_id);
